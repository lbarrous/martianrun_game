...
public class GameStage extends Stage implements ContactListener {
    ...
    private void setUpAchievementsList() {
        Rectangle gameLabelBounds = new Rectangle(0, getCamera().viewportHeight * 5 / 8,
                getCamera().viewportWidth, getCamera().viewportHeight / 4);
        addActor(new AchievementsLabel(gameLabelBounds));
    }
    ...
    private class GameLeaderboardButtonListener
        ...
        public void onLeaderboard() {
            GameManager.getInstance().setGameState(GameState.SCORES);
            clear();
            setUpStageBase();
            setUpGameLabel();
            setUpLeaderBoard();
    ...
    private class GameAchievementsButtonListener
        ...
        public void onAchievements() {
            GameManager.getInstance().setGameState(GameState.ACHIEVEMENTS);
            clear();
            setUpStageBase();
            setUpGameLabel();
            //setUpAchievements();
