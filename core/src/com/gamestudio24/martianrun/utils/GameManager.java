...
public class GameManager implements GameEventListener {
    ...
    public void submitScore(int score) {
        ...
        if (score > 500 && !scores.isrreach500()) {
            scores.reach500();
        }

        if (score > 1000 && !scores.isrreach1000()) {
            scores.reach1000();
        }

        if (score > 2500 && !scores.isrreach2500()) {
            scores.reach2500();
        }

        if (score > 5000 && !scores.isrreach5000()) {
            scores.reach5000();
        }
    }
