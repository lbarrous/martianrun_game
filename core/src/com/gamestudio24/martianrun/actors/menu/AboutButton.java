...
public class AboutButton extends GameButton {
    ...
    protected String getRegionName() {
        return GameManager.getInstance().getGameState() == GameState.ABOUT || GameManager.getInstance().getGameState() == GameState.SCORES || GameManager.getInstance().getGameState() == GameState.ACHIEVEMENTS ? Constants.CLOSE_REGION_NAME :
